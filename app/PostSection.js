export default function PostSection() {
  return (
    <section className="relative bg-[#EAF4EC] px-4 py-12 text-center overflow-hidden">
      {/* Háttér dekoráció */}
      <div
      ...
      {/* Címsor */}
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#0E0E0F] z-10 relative">
