export default function HeroSection() {
  return (
    <>
      <section className="relative sm:hidden pt-24 bg-[#0E0E0F] flex flex-col items-center text-center px-4 py-8 text-white space-y-10">
      ...
      <section className="hidden  sm:flex flex-row relative pt-24 bg-[#0E0E0F]  text-left px-4 py-8 text-white space-y-10">
        <div className=" text-2xl px-32 py-16 sm:text-3xl md:text-4xl font-semibold z-10">
          <h2>Lépj be a</h2>
          <h2 className="text-[#67FFF2]">Hyper-Realitás</h2>
          <h2>világába</h2>
          <div className="py-10">
            <p className="text-lg py-8 font-medium z-10">
