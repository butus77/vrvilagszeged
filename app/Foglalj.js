export default function Foglalj() {
  return (
    <>
      {/* Címsor */}
      <h2 className="py-10 text-center text-[#EAF4EC] text-4xl sm:text-6xl md:text-7xl font-bold leading-tight">
        Foglalj!
      </h2>

      {/* Lépések gridben */}
      <section className="bg-transparent px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-6 gap-x-8 max-w-6xl mx-auto py-20">
          {/* 1. lépés */}
